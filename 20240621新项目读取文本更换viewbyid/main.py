...
class IDReplace:
    ...
    def __init__(self):
        self.findId = re.compile(r'@ViewById.*R\.id\.(\w*)')
    ...
    def replaceText(self,path):
        ...
        for (index, line) in enumerate(textLines, 0):
            ...
            if search:
                ...
                idBean = {"id": xmlId, "bianliang": bianliangName, "i": index}
    ...
    def dotask(self):
        fuPath = r'G:\work\petshop202406\agent\src\main\java\com\centre\agent\centre'
...
if __name__ == '__main__':
    path = r'G:\work\petshop202406\centre\src\main\java\com\centre\workoffice\centre\c_production\activity\MaterialRequisitionDetailBackActivity.java'
    task = IDReplace()
    # task.dotask()
